...
<link type="text/css" rel="stylesheet" href="{{asset('public/css/common.css')}}"> 
<link type="text/css" rel="stylesheet" href="{{asset('public/css/index.css')}}">
                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{($p->money-$p->revice)/100}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{sprintf('%.2f',$p->revice/$p->money)*100}}">{{sprintf('%d',($p->revice/$p->money)*100)}}%</span>
                            </li>
                            <li class="w5">
    ...
    <!--金额安全 s-->
            <div class="module mb_20 ind_partner holidy_main_no4">
                ...
                <ul class="par_box">
                    ...
                    <li>
                        <span><img width="185" height="84" alt="" src="public/image/ind_par2.png"></span>
                        <a class="a6" href="#">
                        点点贷风险保证金托管<br>
    中国光大银行上海分行
                        </a>
                     ...
                     <li>
                    <span><img width="185" height="84" alt="" src="public/image/ind_par5.png"></span>
                    <a class="a6" href="#">
                    ...
                    <li>
                        <span><img width="185" height="84" alt="" src="public/image/ind_par4.png"></span>
                        <a class="a6" href="#">
                       点点贷使用美国FICO<br>
    决策引擎建立评分卡系统
                        </a>
                    ...
                    <li>
                        <span><img width="185" height="84" alt="公安部第三研究所" src="public/image/ind_par1.png"></span>
                        <a class="a6" href="#">
                        点点贷信息安全通过<br> 
                        公安部等保二级测评
                        </a>
                    ...
                    <li>
                        <span><img width="185" height="84" alt="" src="public/image/ind_par3.png"></span>
                        <a class="a6" href="#">
                        点点贷违约客户数据对<br>
    接报送上海资信有限公司
                        </a>
...
<a target="_blank" href="#">Z</a>|丨
        ...
        <div class="police">
            <a href="#" target="_blank" class="img1" rel="nofollow"><img width="70" height="32" src="public/image/px_003.gif"></a>
            <a href="#" target="_blank" class="img2" rel="nofollow"><img width="70" height="32" src="public/image/px_003.gif"></a>
            <a href="#" target="_blank" class="img3" rel="nofollow"><img width="70" height="32" src="public/image/px.gif"></a>
            <a href="#" target="_blank" class="img4" rel="nofollow"><img width="70" height="32" src="public/image/px.gif"></a>
            <a href="#" target="_blank" class="img5" rel="nofollow"><img width="70" height="32" src="public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img6" rel="nofollow"><img width="70" height="32" src="public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img7" rel="nofollow"><img width="70" height="32" src="public/image/px.gif"></a>
            <a href="#" target="_blank" class="img8" rel="nofollow"><img width="70" height="32" src="public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img9" rel="nofollow"><img width="70" height="32" src="public/image/px.gif"></a>
        </div>
    </div>
</div>
...
<div class="plusBank2">
    ...
    <div class="ewm02">
        <img width="430" height="430" src="public/image/ewm.jpg">
    </div>
</div>
<!-- weixin end -->
