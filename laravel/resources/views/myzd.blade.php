...
<link type="text/css" rel="stylesheet" href="/laravel/public/css/common.css"> 
<link type="text/css" rel="stylesheet" href="/laravel/public/css/sea.css">
<link type="text/css" rel="stylesheet" href="/laravel/public/css/style.css">
...
<div class="niwdoawi_center">
	<div class="w1000 logo clearfix">
    	<a class="fl pl_20 logo_a holiday_logo" title="给梦想可能" href="#"><img height="52" alt="点点贷" src="/laravel/public/image/logo_all.png"></a>
        <div class="fl logo_aft">
        	<div id="headLogo" class="pos_aft">
            			<a href="#" class="defaultlogo"><img src="/laravel/public/image/logo1200.png"></a>
            </div>
        </div>
        <div class="fr righ">
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                   <td class="f">{{$h->hid}}</td>
                                   <td class="f">{{$h->title}}</td>
                                   <td class="f">{{$h->amount/100}}</td>
                                   <td class="f">{{$h->paydate}}</td>
                                   @if($h->status == 0)
                                   <td class="f"><a href="">还款</a></td>
                                   @else
                                   <td class="f">已还</td>
                                   @endif             
                                </tr>
...
<a target="_blank" href="#">Z</a>|丨
        ...
        <div class="police">
        	<a href="#" target="_blank" class="img1" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img2" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img3" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px.gif"></a>
            <a href="#" target="_blank" class="img4" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img5" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img6" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px.gif"></a>
            <a href="#" target="_blank" class="img7" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img8" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
            <a href="#" target="_blank" class="img9" rel="nofollow"><img width="70" height="32" src="/laravel/public/image/px_002.gif"></a>
        </div>
    </div>
</div>
...
<div class="plusBank2">
    ...
    <div class="ewm02">
        <img width="430" height="430" src="/laravel/public/image/ewm.jpg">
    </div>
</div>
<!-- weixin end -->
<!--foot End-->
...
<link rel="stylesheet" href="/laravel/public/css/grey2013.css"> 

<!--时间  s-->

<link type="text/css" rel="stylesheet" href="/laravel/public/css/jquery-ui.css"> 
